...
namespace Gestion_Constructora.provinciaDataSetTableAdapters {
    ...
    public partial class provinciaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `provincia` WHERE ((`id` = @p1) AND (`nombre` = @p2))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `provincia` (`nombre`) VALUES (@p1)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `provincia` SET `nombre` = @p1 WHERE ((`id` = @p2) AND (`nombre` = @p3))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `nombre` FROM `provincia`";
        ...
        public virtual int Fill(provinciaDataSet.provinciaDataTable dataTable) {
        ...
        public virtual provinciaDataSet.provinciaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            provinciaDataSet.provinciaDataTable dataTable = new provinciaDataSet.provinciaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(provinciaDataSet.provinciaDataTable dataTable) {
        ...
        public virtual int UpdateAll(provinciaDataSet dataSet) {
            ...
            try {
                ...
                if ((this._provinciaTableAdapter != null)) {
                    ...
                    this._provinciaTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(workConnection));
                    this._provinciaTableAdapter.Transaction = ((global::MySql.Data.MySqlClient.MySqlTransaction)(workTransaction));
                ...
                if ((this._provinciaTableAdapter != null)) {
                    this._provinciaTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(revertConnections[this._provinciaTableAdapter]));
