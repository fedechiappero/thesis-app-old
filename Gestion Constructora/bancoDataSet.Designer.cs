...
namespace Gestion_Constructora {
    ...
    public partial class bancoDataSet : global::System.Data.DataSet {
        ...
        public partial class bancoDataTable : global::System.Data.TypedTableBase<bancoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public bancoRow AddbancoRow(string nombre) {
...
namespace Gestion_Constructora.bancoDataSetTableAdapters {
    ...
    public partial class bancoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `banco` WHERE ((`id` = @p1) AND (`nombre` = @p2))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `banco` SET `nombre` = @p1 WHERE ((`id` = @p2) AND (`nombre` = @p3))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id`, `nombre` FROM `banco` WHERE `activo` = 1";
        ...
        public virtual int Fill(bancoDataSet.bancoDataTable dataTable) {
        ...
        public virtual bancoDataSet.bancoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bancoDataSet.bancoDataTable dataTable = new bancoDataSet.bancoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bancoDataSet.bancoDataTable dataTable) {
        ...
        public virtual int UpdateAll(bancoDataSet dataSet) {
            ...
            try {
                ...
                if ((this._bancoTableAdapter != null)) {
                    ...
                    this._bancoTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(workConnection));
                    this._bancoTableAdapter.Transaction = ((global::MySql.Data.MySqlClient.MySqlTransaction)(workTransaction));
                ...
                if ((this._bancoTableAdapter != null)) {
                    this._bancoTableAdapter.Connection = ((global::MySql.Data.MySqlClient.MySqlConnection)(revertConnections[this._bancoTableAdapter]));
